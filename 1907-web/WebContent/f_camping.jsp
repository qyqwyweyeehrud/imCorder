			...
			<div id ='mid_in_f'>
				<div id='left_f'>
					<div id='check_f'><!-- 체크박스 들어간 div -->
						...
						<h4>캠핑유형</h4>
						<div id='chk_f'><input type="checkbox" name='htype' id='htype1_f' value=''/><label for='htype1_f'><span></span>&nbsp;&nbsp;&nbsp;오토캠핑</label></div>
						<div id='chk_f'><input type="checkbox" name='htype' id='htype2_f' value=''/><label for='htype2_f'><span></span>&nbsp;&nbsp;&nbsp;글램핑</label></div>
						<div id='chk_f'><input type="checkbox" name='htype' id='htype3_f' value=''/><label for='htype3_f'><span></span>&nbsp;&nbsp;&nbsp;카라반</label></div>
						...
						<h4>공용시설</h4>
						<div id='chk_f'><input type="checkbox" name='public' id='public1_f' value=''/><label for='public1_f'><span></span>&nbsp;&nbsp;&nbsp;전기</label></div>
						<div id='chk_f'><input type="checkbox" name='public' id='public2_f' value=''/><label for='public2_f'><span></span>&nbsp;&nbsp;&nbsp;개수대</label></div>
						<div id='chk_f'><input type="checkbox" name='public' id='public3_f' value=''/><label for='public3_f'><span></span>&nbsp;&nbsp;&nbsp;매점</label></div>
						<div id='chk_f'><input type="checkbox" name='public' id='public4_f' value=''/><label for='public4_f'><span></span>&nbsp;&nbsp;&nbsp;화장실</label></div>
						<div id='chk_f'><input type="checkbox" name='public' id='public5_f' value=''/><label for='public5_f'><span></span>&nbsp;&nbsp;&nbsp;카페</label></div>
						...
						<div id='chk_f'><input type="checkbox" name='etc' id='etc2_f' value=''/><label for='etc2_f'><span></span>&nbsp;&nbsp;&nbsp;사이트주차</label></div>
						<div id='chk_f'><input type="checkbox" name='etc' id='etc3_f' value=''/><label for='etc3_f'><span></span>&nbsp;&nbsp;&nbsp;장비대여</label></div>
						<div id='chk_f'><input type="checkbox" name='etc' id='etc4_f' value=''/><label for='etc4_f'><span></span>&nbsp;&nbsp;&nbsp;픽업가능</label></div>
					</div>
				</div>
				<div id ='right_f'>
